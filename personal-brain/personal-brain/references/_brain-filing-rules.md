...
| Meeting about a project → `meetings/` only | → ALSO update `projects/` | Entity propagation is mandatory |
...
If the content has a clear primary subject (a person, company, concept, project),
...
- **Projects:** Is this an active project you need to track?
